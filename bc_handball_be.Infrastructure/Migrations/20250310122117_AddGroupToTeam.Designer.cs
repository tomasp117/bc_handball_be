...
namespace bc_handball_be.Infrastructure.Migrations
{
    ...
    [Migration("20250310122117_AddGroupToTeam")]
    partial class AddGroupToTeam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("bc_handball_be.Core.Entities.Player", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("bc_handball_be.Core.Entities.Actors.sub.Admin", b =>
                {
                    b.HasBaseType("bc_handball_be.Core.Entities.Actors.super.Person");
            ...
            modelBuilder.Entity("bc_handball_be.Core.Entities.Actors.sub.Admin", b =>
                {
                    b.HasOne("bc_handball_be.Core.Entities.Actors.super.Person", null)
                        .WithOne()
                        .HasForeignKey("bc_handball_be.Core.Entities.Actors.sub.Admin", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("bc_handball_be.Core.Entities.Actors.sub.Coach", b =>
                {
                    ...
                    b.HasOne("bc_handball_be.Core.Entities.Actors.super.Person", null)
                        .WithOne()
                        .HasForeignKey("bc_handball_be.Core.Entities.Actors.sub.Coach", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("bc_handball_be.Core.Entities.Actors.sub.Recorder", b =>
                {
                    b.HasOne("bc_handball_be.Core.Entities.Actors.super.Person", null)
                        .WithOne()
                        .HasForeignKey("bc_handball_be.Core.Entities.Actors.sub.Recorder", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("bc_handball_be.Core.Entities.Actors.sub.Referee", b =>
                {
                    b.HasOne("bc_handball_be.Core.Entities.Actors.super.Person", null)
                        .WithOne()
                        .HasForeignKey("bc_handball_be.Core.Entities.Actors.sub.Referee", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
