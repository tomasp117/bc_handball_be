...
using System.Text;
using AutoMapper;
using bc_handball_be.API.DTOs.Auth;
...
using bc_handball_be.API.DTOs.Referees;
    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Team, TeamDTO>()
                ...
                .ForMember(
                    dest => dest.TournamentInstanceNum,
                    opt => opt.MapFrom(src => src.TournamentInstance.EditionNumber)
                )
                .ForMember(
                    dest => dest.GroupIds,
                    opt => opt.MapFrom(src => src.TeamGroups.Select(tg => tg.GroupId))
                )
                .ForMember(
                    dest => dest.GroupNames,
                    opt => opt.MapFrom(src => src.TeamGroups.Select(tg => tg.Group.Name))
                );
            ...
            CreateMap<PlayerDetailDTO, Player>()
                ...
                .ForMember(
                    dest => dest.SevenMeterGoalCount,
                    opt => opt.MapFrom(src => src.SevenMeterGoalCount)
                )
                .ForMember(
                    dest => dest.SevenMeterMissCount,
                    opt => opt.MapFrom(src => src.SevenMeterMissCount)
                )
                .ForMember(
                    dest => dest.TwoMinPenaltyCount,
                    opt => opt.MapFrom(src => src.TwoMinPenaltyCount)
                )
                .ForMember(dest => dest.RedCardCount, opt => opt.MapFrom(src => src.RedCardCount))
                .ForMember(
                    dest => dest.YellowCardCount,
                    opt => opt.MapFrom(src => src.YellowCardCount)
                )
            ...
            CreateMap<ClubCsvDTO, Club>()
                .ForMember(
                    dest => dest.Logo,
                    opt =>
                        opt.MapFrom(src => RemoveDiacritics(src.Name.ToLower().Replace(" ", "-")))
                );
            ...
            CreateMap<ClubCreateDTO, Club>()
                ...
                .ForMember(dest => dest.ClubAdmin, opt => opt.Ignore())
                .ForMember(dest => dest.Teams, opt => opt.Ignore())
                .ForMember(dest => dest.ClubRegistration, opt => opt.Ignore())
                .ForMember(dest => dest.IsPlaceholder, opt => opt.Ignore())
                .ForMember(
                    dest => dest.Logo,
                    opt =>
            ...
            CreateMap<ClubAdminRegisterDTO, Person>()
                .ForMember(dest => dest.Id, opt => opt.Ignore())
                .ForMember(dest => dest.Login, opt => opt.Ignore()); // Created separately in service
            ...
            CreateMap<ClubAdminCreateDTO, ClubAdmin>()
                .ForMember(dest => dest.Person, opt => opt.MapFrom(src => src));

            CreateMap<ClubAdminCreateDTO, Person>()
                .ForMember(
                    dest => dest.Login,
                    opt => opt.MapFrom(src => new Login { Username = src.Username })
                )
            ...
            CreateMap<Group, GroupDetailDTO>()
                ...
                .ForMember(
                    dest => dest.Teams,
                    opt => opt.MapFrom(src => src.TeamGroups.Select(tg => tg.Team))
                )
            ...
            CreateMap<BracketGroupDTO, Group>()
                .ForMember(
                    dest => dest.TeamGroups,
                    opt =>
                        opt.MapFrom(src =>
                            src.Teams.Select(t => new TeamGroup { TeamId = t.Id }).ToList()
                        )
                )
            ...
            CreateMap<Match, MatchDetailDTO>()
                ...
                .ForMember(
                    dest => dest.MainRefereeName,
                    opt =>
                        opt.MapFrom(src =>
                            src.MainReferee != null
                                ? $"{src.MainReferee.Person.FirstName} {src.MainReferee.Person.LastName}"
                                : null
                        )
                )
                .ForMember(
                    dest => dest.AssistantRefereeName,
                    opt =>
                        opt.MapFrom(src =>
                            src.AssistantReferee != null
                                ? $"{src.AssistantReferee.Person.FirstName} {src.AssistantReferee.Person.LastName}"
                                : null
                        )
                );
            ...
            CreateMap<Person, PersonDetailDTO>().IncludeBase<Person, PersonDTO>();

            CreateMap<CoachCreateDTO, Person>()
                .ForMember(
                    dest => dest.Login,
                    opt =>
                        opt.MapFrom(src => new Login
                        {
            ...
            // ClubRegistration
            CreateMap<ClubRegistration, ClubRegistrationDTO>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status.ToString()))
                .ForMember(dest => dest.ClubName, opt => opt.MapFrom(src => src.Club.Name))
                .ForMember(
                    dest => dest.TournamentInstanceNumber,
                    opt => opt.MapFrom(src => src.TournamentInstance.EditionNumber)
                )
                .ForMember(
                    dest => dest.CategoryTeamCounts,
                    opt => opt.MapFrom(src => src.CategoryTeamCounts)
                );

            CreateMap<ClubRegistrationCreateDTO, ClubRegistration>()
                .ForMember(dest => dest.Id, opt => opt.Ignore())
                .ForMember(dest => dest.CalculatedFee, opt => opt.Ignore())
            ...
            CreateMap<ClubRegistrationCategory, ClubRegistrationCategoryDTO>()
                .ForMember(dest => dest.CategoryName, opt => opt.MapFrom(src => src.Category.Name));

            CreateMap<ClubRegistrationCategoryCreateDTO, ClubRegistrationCategory>()
                .ForMember(dest => dest.Id, opt => opt.Ignore())
                .ForMember(dest => dest.ClubRegistrationId, opt => opt.Ignore())
                .ForMember(dest => dest.ClubRegistration, opt => opt.Ignore())
                .ForMember(dest => dest.Category, opt => opt.Ignore());
        }
